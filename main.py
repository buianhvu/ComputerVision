...
validation_set = Dataset(val_ids, val_labels, 'val',transform=transforms.Compose([Rescale(512),ToTensor()]))
...
test_set = Dataset(test_ids, test_labels, 'test', transform=transforms.Compose([Rescale(512),ToTensor()]))
