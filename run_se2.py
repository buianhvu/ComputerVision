...
if __name__ == '__main__':
    ...
    _, train_loader = get_loader(root=input_folder, batch_size=batch_size, number_of_workers=batch_size)
    ...
    _, test_loader = get_loader(root=input_folder, inside="evaluation", batch_size=batch_size, number_of_workers=batch_size)
